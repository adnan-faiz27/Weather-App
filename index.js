  ...
  function showicon()
  {
    if(forecast[i].weather.description=="Thunderstorm with heavy rain"||forecast[i].weather.description=="Storm" ||forecast[i].weather.description=="Heavy Storm"){
      icon.innerHTML=`<i class="uil uil-thunderstorm"></i>`;
    }
    else if(forecast[i].weather.description=="Few clouds" || forecast[i].weather.description=="Scattered clouds" || forecast[i].weather.description=="Scattered clouds" || forecast[i].weather.description=="Overcast clouds" ||forecast[i].weather.description=="Broken clouds"){
      icon.innerHTML=`<i class="uil uil-clouds"></i>`;
    }
    else if(forecast[i].weather.description=="Snow" || forecast[i].weather.description=="Light Snow" || forecast[i].weather.description=="Moderate Snow" || forecast[i].weather.description=="Heavy Snow"){
    ...
    else if(forecast[i].weather.description=="Light rain" || forecast[i].weather.description=="Mix snow/rain"){
      icon.innerHTML=`<i class="uil uil-cloud-drizzle"></i>`;
    }
    else if(forecast[i].weather.description=="Moderate rain"||forecast[i].weather.description=="Light shower rain"){
  ...
  async function getforecast(lat , long) {
    const resp = await fetch(`https://weatherbit-v1-mashape.p.rapidapi.com/forecast/daily?lat=${lat}&lon=${long}`, options)
